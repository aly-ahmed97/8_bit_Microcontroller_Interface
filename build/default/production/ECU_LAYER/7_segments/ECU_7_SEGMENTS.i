# 1 "ECU_LAYER/7_segments/ECU_7_SEGMENTS.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_LAYER/7_segments/ECU_7_SEGMENTS.c" 2
# 1 "ECU_LAYER/7_segments/ECU_7_SEGMENTS.h" 1
# 14 "ECU_LAYER/7_segments/ECU_7_SEGMENTS.h"
# 1 "ECU_LAYER/7_segments/ECU_7_SEGMENTS_CONFIG.h" 1
# 14 "ECU_LAYER/7_segments/ECU_7_SEGMENTS.h" 2

# 1 "ECU_LAYER/7_segments/../../MCAL_LAYER/GPIO/HAL_GPIO.h" 1
# 13 "ECU_LAYER/7_segments/../../MCAL_LAYER/GPIO/HAL_GPIO.h"
...
# 13 "ECU_LAYER/7_segments/../../MCAL_LAYER/GPIO/../MCAL_STD_TYPES.h"
...
# 13 "ECU_LAYER/7_segments/../../MCAL_LAYER/GPIO/../MCAL_STD_TYPES.h" 2
...
# 15 "ECU_LAYER/7_segments/../../MCAL_LAYER/GPIO/HAL_GPIO.h" 2

# 1 "ECU_LAYER/7_segments/../../MCAL_LAYER/GPIO/HAL_GPIO_CFG.h" 1
# 16 "ECU_LAYER/7_segments/../../MCAL_LAYER/GPIO/HAL_GPIO.h" 2
# 39 "ECU_LAYER/7_segments/../../MCAL_LAYER/GPIO/HAL_GPIO.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 15 "ECU_LAYER/7_segments/ECU_7_SEGMENTS.h" 2
# 30 "ECU_LAYER/7_segments/ECU_7_SEGMENTS.h"
typedef enum{
...
# 1 "ECU_LAYER/7_segments/ECU_7_SEGMENTS.c" 2
# 11 "ECU_LAYER/7_segments/ECU_7_SEGMENTS.c"
Std_ReturnType _7_segments_init(const _7_segments_t *seg){
    ...
    {
        ret = gpio_pin_init(&(seg->segment_bits[0]));
        ret = gpio_pin_init(&(seg->segment_bits[1]));
        ret = gpio_pin_init(&(seg->segment_bits[2]));
        ret = gpio_pin_init(&(seg->segment_bits[3]));
    }
    return ret ;
}
# 36 "ECU_LAYER/7_segments/ECU_7_SEGMENTS.c"
Std_ReturnType _7_segments_write_number(const _7_segments_t *seg,uint8_t num){
   Std_ReturnType ret = (Std_ReturnType)0x01 ;
    if(((void*)0) == seg || num > 9)
    {
    ...
    {
        ret = gpio_pin_write_logic(&(seg->segment_bits[0]),(num>>0) & 0x01);
        ret = gpio_pin_write_logic(&(seg->segment_bits[1]),(num>>1) & 0x01);
        ret = gpio_pin_write_logic(&(seg->segment_bits[2]),(num>>2) & 0x02);
        ret = gpio_pin_write_logic(&(seg->segment_bits[3]),(num>>3) & 0x03);
    }
    return ret ;
}
