...
# 15 "ECU_LAYER/DC_MOTOR/ECU_DC_MOTOR.c"
Std_ReturnType Dc_Motor_INIT(const Dc_Motor_t * dc_motor){
    ...
    {
            pin1.Port = dc_motor->dc_motor_pin[0x00U].Pin_Port ;
            pin1.Pin_Number = dc_motor->dc_motor_pin[0x00U].Pin_Pin ;
            pin1.Direction = GPIO_OUTPUT ;
            pin1.Logic = dc_motor->dc_motor_pin[0x00U].Pin_statues;

            pin2.Port = dc_motor->dc_motor_pin[0x01U].Pin_Port ;
            pin2.Pin_Number = dc_motor->dc_motor_pin[0x01U].Pin_Pin ;
            pin2.Direction = GPIO_OUTPUT ;
            pin2.Logic = dc_motor->dc_motor_pin[0x01U].Pin_statues;
...
# 91 "ECU_LAYER/DC_MOTOR/ECU_DC_MOTOR.c"
Std_ReturnType Dc_Motor_Stop(const Dc_Motor_t * dc_motor){
    Std_ReturnType ret = (Std_ReturnType)0x01 ;
    if(((void*)0) == dc_motor)
    {
